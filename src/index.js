...
var allResolvers_1 = require("./resolvers/allResolvers");
var mongoLocal = require('./db/mongo').mongoLocal;
/**
 * App
 * @type {Express}
    ...
    return __generator(this, function (_f) {
        switch (_f.label) {
            case 0:
                _b = (_a = app).use;
                _c = ['/graphql'];
                _d = express_graphql_1.graphqlHTTP;
                _e = {};
            ...
            case 1:
                _b.apply(_a, _c.concat([_d.apply(void 0, [(_e.schema = _f.sent(),
                            ...
                            _e)])]));
                mongoLocal();
                app.get("/", function (_req, res) { return res.send("Hello Ozzy"); });
